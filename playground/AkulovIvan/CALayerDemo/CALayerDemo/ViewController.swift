...
class ViewController: UIViewController, CAAnimationDelegate {
    ...
    var gradientLayer: CAGradientLayer! {
        didSet {
            ...
            let startColor = #colorLiteral(red: 0.2392156869, green: 0.6745098233, blue: 0.9686274529, alpha: 1).cgColor // color literal
            //let middleColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1).cgColor
    ...
    override func viewDidLayoutSubviews() {
        //gradientLayer.frame = CGRect(x: 0, y: 0, width: self.view.bounds.size.width, height: 20 + 21 + imageView.bounds.height / 2)
        // рисуем слой градиента только от начала экрана до половины картинки
        gradientLayer.frame = CGRect(x: 0, y: 0, width: self.view.bounds.size.width, height: imageView.frame.maxY - imageView.bounds.size.height / 2)
    ...
    @IBAction func tapMeButonPressed(_ sender: UIButton) {
