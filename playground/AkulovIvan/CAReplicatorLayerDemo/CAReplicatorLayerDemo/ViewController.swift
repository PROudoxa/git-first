...
class ViewController: UIViewController {
    ...
    override func viewWillLayoutSubviews() {
        ...
        //sourceLayer.frame = CGRect(x: 0.0, y: 0.0, width: 3, height: 117)
        ...
        //sourceLayer.anchorPoint = CGPoint(x: 0.0, y: 0.0)
    }
    ...
    func startAnimation(delay: TimeInterval, replicates: Int) {
        ...
        sourceLayer.add(opacityAnimation, forKey: "someKeyForThisAnimation")
    }
}
