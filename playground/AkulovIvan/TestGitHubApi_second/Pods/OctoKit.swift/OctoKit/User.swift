...
public extension Octokit {
    ...
    */
    ...
    /**
        ...
        - parameter completion: Callback for the outcome of the fetch.
    */
    @discardableResult public func me(_ session: RequestKitURLSession = URLSession.shared, completion: @escaping (_ response: Response<User>) -> Void) -> URLSessionDataTaskProtocol? {
