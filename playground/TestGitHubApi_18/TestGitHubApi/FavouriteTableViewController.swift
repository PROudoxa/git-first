...
//            let indexPathAuto = tableView.indexPathForSelectedRow
//            print(indexPathAuto?.row ?? "failed!")
//
//            if let navigationController = segue.destination as? UINavigationController {
//                print("here")
//                if let detailViewController = navigationController.topViewController as? EditFavouriteViewController {
//                    print("bingo")
//                }
//            }
...
//            guard let editViewController = segue.destination as? EditFavouriteViewController,
//                let indexPath = selectedIndexPath  else { fatalError("guard: Application storyboard mis-configuration") }
            
            let repositoryEntry = fetchedResultsController.object(at: indexPath)
            
            //print(repositoryEntry.description)
...
//            self.fetchedResultsController = self.favouriteListFetchedResultsController()
//        }
